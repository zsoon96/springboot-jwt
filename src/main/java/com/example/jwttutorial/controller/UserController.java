...
public class UserController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<UserReqDto> signup(@Valid @RequestBody UserReqDto userReqDto) {
    ...
    public ResponseEntity<UserReqDto> getMyUserInfo() {
        return ResponseEntity.ok(userService.getMyUserWithAuthorities());
    }

    @GetMapping("/user/{username}")
    @PreAuthorize("hasAnyRole('ADMIN')")
    public ResponseEntity<UserReqDto> getUserInfo(@PathVariable String username) {
